...
export default function DeleteProjectModal() {
    ...
    const deleteProjectMutation = useMutation({
      ...
      onSuccess: (data) => {
        toast.success(data)
        queryClient.invalidateQueries({ queryKey: ['projects'] }) // Forzar un nuevo refetch o Traer datos nuevos
    ...
    const handleForm = async (formData : CheckPasswordForm) => {
        await checkUserPasswordMutation.mutateAsync(formData) // Forma asincrona del mutate para ejecutar secuencialmente los mutate
