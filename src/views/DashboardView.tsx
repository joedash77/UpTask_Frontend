                ...
                <Menu as="div" className="relative flex-none">
                  ...
                  <Transition as={Fragment} enter="transition ease-out duration-100"
                    ...
                    >
                      <MenuItem>
                        <Link to={`/projects/${project._id}`}
                          className='block px-3 py-1 text-sm leading-6 text-gray-900 hover:text-gray-400 cursor-pointer'>
                          Ver Proyecto
                        </Link>
                      </MenuItem>
                      ...
                      {isManager(project.manager, user._id) && (
                        <>
                          ...
                          <MenuItem>
                            <button
                              type='button'
                              className='block px-3 py-1 text-sm leading-6 text-red-500 hover:text-red-300 cursor-pointer'
