...
export default function ProjectTeamView() {
    ...
    const { mutate } = useMutation({
        ...
        onSuccess: (data) => {
            ...
            toast.success(data)
            queryClient.invalidateQueries({queryKey: ['projectTeam', projectId]}) // Refetch
        }
    })
        ...
        <>
            ...
            <nav className="my-5 flex gap-3">
                ...
                <Link
                    ...
                    className="bg-fuchsia-600 hover:bg-fuchsia-600 px-10 py-3 text-white text-xl font-bold cursor-pointer transition-colors"
